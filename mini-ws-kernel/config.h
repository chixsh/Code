...
//#define PACKAGE_STRING "wireshark 1.5.1"
...
//lhz+
#define PM_TYPE_MTP2			1
#define PM_TYPE_MTP3			2
#define PM_TYPE_ATM			3
#define HFILL_REF 0, 0, HF_REF_TYPE_DIRECT, 0, NULL, NULL
//lhz-
